                ...
                <div class="col-md-12 text-center">
                    ...
                    <p>
                        <a href="#" class="btn btn-info btn-lg" onclick="window.open(
                          'https://twitter.com/share?url='+encodeURIComponent('http://laravel-tricks.com')+'&amp;text='+encodeURIComponent('Tips and Tricks for @laravelphp  from @laraveltricks  #php #dev #tips') + '&amp;count=none/',
                      ...
                      <a href="#" class="btn btn-lg btn-primary" style="border-color: #4B7FCC; color: #428bca;" onclick="window.open(
                          'https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://laravel-tricks.com') +'&amp;t=' + encodeURIComponent('Useful Tips and Tricks for Laravel PHP framework'),
